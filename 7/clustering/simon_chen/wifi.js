...
var yScale;
var items,ccircles;
var clustercolors = ['purple','blue','brown','red','green'];
...
var recenter = function(centroids, data){
	...
	var avgs = _.map(d,function(a,b){return parseInt(d)/z[i].length;});
	d.features = avgs;
    });
...
var dist = function(a,b){
    return _.reduce(_.map(_.zip(a,b),function(d) {return (d[0]-d[1])*(d[0]-d[1]);}),function(a,b) {return a+b;},0);
}
